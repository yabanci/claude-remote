...
func (b *Bridge) ensureRunning(ctx context.Context, chatID int64, s sessionRef) bool {
	...
	if _, err := WaitForSettle(ctx, b.watchVisible(s.name), b.cfg.Settle, b.noticeSessionStillStarting(ctx, chatID, s.name)); err != nil {
...
func (b *Bridge) sendAndAwait(ctx context.Context, chatID int64, name, text string) bool {
	...
	if _, err := WaitForSettle(ctx, b.watchVisible(name), b.cfg.Settle, b.noticeAnswerStillComing(ctx, chatID)); err != nil {
